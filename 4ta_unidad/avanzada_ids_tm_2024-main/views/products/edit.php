        ...
        <div class="row">
          ...
          <div class="col-xl-6">
            <div class="card">
              ...
              <div class="card-body">
                <form method="POST" action="resources" class="p-3" id="editForm">
                  <h5>Name</h5>
                  <input type="text" class="form-control name" required name="name" value="<?php echo $data->name ?>">

                  <h5>slug</h5>
                  <input type="text" class="form-control slug" required name="slug" value="<?php echo $data->slug ?>">

                  <h5>Description</h5>
                  <textarea type="text" class="form-control description" required name="description"><?php echo $data->description ?></textarea>

                  <h5>Features</h5>
                  <textarea type="text" class="form-control features" required name="features"><?php echo $data->features ?></textarea>

                  <h5>Id</h5>
                  <input type="text" class="form-control id" required name="id" value="<?php echo $data->id ?>">
