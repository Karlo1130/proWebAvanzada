	...
	<div class=""> 
	 	...
	 	<div class="container-fluid">
			...
			<div class="d-flex justify-content-end m-3">
				...
				?>
				<!-- <button class="btn btn-success w-auto" data-bs-toggle="modal" data-bs-target="#<?php //echo $idModal ?>">Add</button> -->
				<button class="btn btn-success w-auto"  data-bs-toggle="modal" data-bs-target="#loginModal">Add</button>
			</div>
				...
				<?php foreach ($data as $tarjeta): ?>
					...
					<div class="card-body">
						...
						<!-- <a href="edit.php?slug=<?php //echo $tarjeta['slug']; ?>" class="btn btn-warning">Edit</a> -->
						<?php
						if (!isset($_SESSION['data'])) {
							$idModal = 'loginModal';
						} else {
						...
						?>
						<!-- <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#<?php //echo $idModal ?>">Edit</button> -->
						<button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#loginModal">Edit</button>
